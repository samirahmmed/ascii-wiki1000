...
interface SearchBarProps {
  ...
  artStyle: string;
  artStyles: string[];
  onArtStyleChange: (event: React.ChangeEvent<HTMLSelectElement>) => void;
  ...
  return (
    <div className="search-container">
      ...
      <div className="style-selector-container">
        <label htmlFor="art-style-selector" className="sr-only">Art Style</label>
        <select 
          id="art-style-selector"
          className="art-style-selector"
          value={artStyle}
